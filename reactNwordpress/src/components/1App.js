    ...
    return (
      <div>
        <div className="main-container">
          <div className="top-bar">
            <p className="top-bar__content">
              We need your help to expand to more countries. Suggest a business{" "}
              <a href="https://forms.gle/Z7Gh48YXqz2cK5iCA" target="_blank">
                Here
              </a>
            </p>
          </div>
          ...
          <header>
            <div className="header-content">
              ...
              <p className="page-title__sub">
                From restaurants to urban orchards. Find what you need below and
                continue to support the black economy.
              </p>
            </div>
          </header>
          ...
          <div className="card-container">
            {this.state.imgLoad === true ? (
              <img className="loadingImage" src={loadingImg} />
            ) : null}
        ...
        <div className="footer">
          👨🏾‍💻 A Work In Progress - Built with 🖤 by{" "}
